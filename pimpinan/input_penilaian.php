							...
							<tr class="text-center">
								...
								<td>
									<select name="nik-<?= $i ?>" class="form-control" required>
										<option value="">-PILIH-</option>
											<?php
												$tb_karyawan = mysqli_query($koneksi, "SELECT nik,nama FROM karyawan");
								...
								<td>
									<select name="idbotbot-<?= $i ?>" class="form-control" required>
										<option value="">-PILIH-</option>
											<?php
												$tb_kriteria = mysqli_query($koneksi, "SELECT * FROM bobotkriteria ORDER BY bobotkriteria.idbotbot ASC");

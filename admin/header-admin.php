...
<head>
  ...
  <body>
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a href="user_data.php" class="nav-item nav-link"><i class="fas fa-user-secret"></i><b> DATA USER</b></a>
      </li>
    </ul>
    <form class="form-inline my-2 my-lg-0">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu">
          <a href="#" class="dropdown-item" data-toggle="modal" data-target="#buatakun">BUAT AKUN</a>

...
?>
	...
	<hr>
					...
					if(mysqli_num_rows($dkaryawan)> 0){
						while($data = mysqli_fetch_array($dkaryawan)){ ?>
							<tr>
								...
								<td><?= $data['status'] ?></td>
								<td>
									<a href="karyawan_edit.php?nik=<?php echo $data['nik']; ?>" title="Edit Data" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-edit" aria-hidden="true"><i class="fas fa-edit"></i></span></a>
									<a href="karyawan_delete.php?nik=<?php echo $data['nik'] ?>" title="Hapus Data" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></a>
								</td>
							</tr>
						<?php }
					}else{
		...
		<div class="form-group">
			...
			<button type="button" class="btn btn-success"><a id="log" href="input_datakaryawan.php"><i class="fas fa-plus"></i></a></button>
